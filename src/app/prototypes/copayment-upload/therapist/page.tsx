...
import UploadCopaymentModal from '@/components/copayment-upload/UploadCopaymentModal';
...
export default function TherapistCopaymentUploadPage() {
  ...
  // Generate next Copayment Batch ID for current therapist
  const generateUploadId = () => {
    ...
    // Extract sequential numbers from their Copayment Batch IDs
  ...
  const handleUpload = (file: File) => {
    const newUpload: CopaymentUpload = {
      id: `copay-${Date.now()}`,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                title="Refresh to see new copayments"
              >
      ...
      {/* Main Content */}
      <div className="container mx-auto px-4 py-6">
        <CopaymentUploadTable uploads={therapistUploads} onViewUpload={handleViewUpload} />
      </div>

      {/* Modals */}
      <UploadCopaymentModal
